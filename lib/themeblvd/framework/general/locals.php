...
function themeblvd_get_all_locals() {
	...
	$locals = array(
		...
		'password'                  => __( 'Password', 'jumpstart' ),
		'password_enter'            => __( 'This content is password protected. To view it please enter your password below.', 'jumpstart' ),
