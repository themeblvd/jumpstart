...
class Theme_Blvd_User_Options {
	...
	public function display( $user ) {
		...
		$select_layouts = array('default' => __('Default', '@@text-domain'));
		...
		// Post Display modes
		$select_modes = array_merge( array('default' =>__('Default', '@@text-domain')), themeblvd_get_modes() );
		...
		<table class="form-table">
			<tbody>
				<tr>
					<th scope="row" valign="top"><?php esc_html_e('Display', '@@text-domain'); ?></th>
					<td>
				...
				<tr>
					<th><label for="_tb_box_icons"><?php esc_html_e('Icon Color', '@@text-domain'); ?></label></th>
					<td>
		...
		<table class="form-table">
			<tbody>
				<tr>
					<th><label for="_tb_sidebar_layout"><?php esc_html_e('Sidebar Layout', '@@text-domain'); ?></label></th>
					<td>
