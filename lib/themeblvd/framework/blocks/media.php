...
function themeblvd_slider( $slider ) {
	...
	themeblvd_deprecated_function(
		...
		'2.7.0',
		null,
		__( 'Avoid using the Theme Blvd Sliders plugin; instead, use sliders built directly into the Theme Blvd Layout Builder, or third-party alternatives.', '@@text-domain' )
	);
