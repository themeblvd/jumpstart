	...
	$options = apply_filters('jumpstart_ex_options', array(
		...
		'header_info' => array(
			...
			'top_apply_border_bottom' => array(
				...
				'name'		=> null,
				'desc'		=> '<strong>'.__('Top Bar Bottom Border', 'themeblvd').'</strong>: '.__('Apply bottom border to the top bar of the header.', 'themeblvd'),
				'std'		=> 0,
				'type'		=> 'checkbox',
				'class'		=> 'trigger'
			),
		...
		'menu' => array(
			...
			'menu_corners' => array(
				...
				'desc'		=> __('Set the border radius of menu corners. Setting to 0px will mean the menu corners are square.', 'themeblvd'),
				'std'		=> '0px',
				'type'		=> 'slide',
				'options'	=> array(
					'units'		=> 'px',
