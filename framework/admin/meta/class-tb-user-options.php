...
class Theme_Blvd_User_Options {
	...
	public function display( $user ) {
				...
				<tr>
					...
					<td>
						...
						<label for="_tb_box_archive_link">
							...
							<?php _e('Display link to user\'s archive in Author Box (on single posts)', 'themeblvd'); ?>
						</label>
					</td>
				</tr>
				<tr>
					<th><label for="_tb_box_icons"><?php _e('Icon Color', 'themeblvd'); ?></label></th>
					<td>
						<select name="_tb_box_icons" id="_tb_box_icons">
							<option value="flat" <?php selected($box_icons, 'flat'); ?>><?php _e('Flat Color', 'themeblvd'); ?></option>
							<option value="dark" <?php selected($box_icons, 'dark'); ?>><?php _e('Flat Dark', 'themeblvd'); ?></option>
							<option value="grey" <?php selected($box_icons, 'grey'); ?>><?php _e('Flat Grey', 'themeblvd'); ?></option>
							<option value="light" <?php selected($box_icons, 'light'); ?>><?php _e('Flat Light', 'themeblvd'); ?></option>
							<option value="color" <?php selected($box_icons, 'color'); ?>><?php _e('Color', 'themeblvd'); ?></option>
						</select>
					</td>
				</tr>
			</tbody>
		...
		<table class="form-table">
			<tbody>
				<tr>
					<th><label for="_tb_sidebar_layout"><?php _e('Sidebar Layout', 'themeblvd'); ?></label></th>
					<td>
				...
				<tr>
					<th><label for="_tb_archive_mode"><?php _e('Post Display', 'themeblvd'); ?></label></th>
					<td>
						<select name="_tb_archive_mode" id="_tb_archive_mode">
							<?php foreach ( $select_modes as $key => $value ) : ?>
								<option value="<?php echo $key; ?>" <?php selected($archive_mode, $key); ?>><?php echo $value; ?></option>
							<?php endforeach; ?>
						</select>
					</td>
				</tr>
