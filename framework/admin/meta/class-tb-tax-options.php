...
class Theme_Blvd_Tax_Options {
	...
	public function edit( $term, $taxonomy ) {
		...
		$select_layouts = array('default' => __('Use default setting', 'themeblvd'));
		...
		// Post Display modes
		$select_modes = array_merge( array('default' => __('Use default setting', 'themeblvd')), themeblvd_get_modes() );
