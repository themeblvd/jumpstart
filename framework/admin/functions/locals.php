	...
	switch ( $type ) {
		...
		case 'js' :
			$locals = array (
				...
				'primary_query'			=> __( 'Oops! You can only have one primary query element or block per layout. A paginated post list or paginated post grid would be examples of primary query elements.', 'themeblvd' ),
