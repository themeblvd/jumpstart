...
class Jump_Start_Updater {
	...
	public function plugin_update_notification( $file, $plugin ) {
		...
		if ( ! current_user_can( 'update_plugins' ) ) {
			...
			printf(
				__( 'There is a new version of %s available. View <a href="%s" target="_blank">version %s details</a>.', '@@text-domain' ),
				$response->name,
				$response->url,
			...
			printf(
				__( 'There is a new version of %s available. View <a href="%s" target="_blank">version %s details</a> or <a href="%s" %s>update now</a>.', '@@text-domain' ),
				$response->name,
				$response->url,
				$response->new_version,
