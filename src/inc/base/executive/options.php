...
function jumpstart_ex_options() {
	...
	$options = array(
		'general' => array(
			...
			'layout_shadow_opacity' => array(
				...
				// translators: 1: link to Background admin screen
		...
		'header_info' => array(
			...
			'top_apply_border_bottom' => array(
				...
				'name'      => null,
				'desc'      => '<strong>' . __( 'Top Bar Bottom Border', '@@text-domain' ) . '</strong>: ' . __( 'Apply bottom border to the top bar of the header.', '@@text-domain' ),
				'std'       => 0,
				'type'      => 'checkbox',
				'class'     => 'trigger',
			),
		...
		'header' => array(
			...
			'header_apply_padding_top' => array(
				...
				'name'      => null,
				'desc'      => '<strong>' . __( 'Top Padding', '@@text-domain' ) . ':</strong> ' . __( 'Apply custom padding top the top of the header.', '@@text-domain' ),
				'std'       => 0,
				'type'      => 'checkbox',
				'class'     => 'trigger',
			),
			...
			'header_apply_padding_bottom' => array(
				...
				'name'      => null,
				'desc'      => '<strong>' . __( 'Bottom Padding', '@@text-domain' ) . ':</strong> ' . __( 'Apply custom padding bottom the bottom of the header.', '@@text-domain' ),
				'std'       => 0,
				'type'      => 'checkbox',
				'class'     => 'trigger',
			),
		...
		'menu' => array(
			...
			'menu_corners' => array(
				'id'        => 'menu_corners',
				'name'      => __( 'Menu Corners', '@@text-domain' ),
				'desc'      => __( 'Set the border radius of menu corners. Setting to 0px will mean the menu corners are square.', '@@text-domain' ),
				'std'       => '0px',
				'type'      => 'slide',
				'options'   => array(
					'units'     => 'px',
			...
			'menu_apply_border' => array(
				...
				'name'      => null,
				'desc'      => '<strong>' . __( 'Border', '@@text-domain' ) . '</strong>: ' . __( 'Apply border around menu.', '@@text-domain' ),
				'std'       => 0,
				'type'      => 'checkbox',
				'class'     => 'trigger',
			),
			...
			'menu_center' => array(
				'id'        => 'menu_center',
				'name'      => null,
				'desc'      => '<strong>' . __( 'Center', '@@text-domain' ) . '</strong>: ' . __( 'Center the main menu.', '@@text-domain' ),
				'std'       => 0,
				'type'      => 'checkbox',
			),
			'menu_search' => array(
	 ...
	 */
	$options = apply_filters( 'jumpstart_ex_options', $options );
	...
	themeblvd_add_option_section( 'styles', 'ex_sticky_header', __( 'Sticky Header', '@@text-domain' ),   null, $options['header_sticky'] );
