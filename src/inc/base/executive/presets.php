...
function jumpstart_ex_get_presets( $preset = '' ) {
    ...
    $atts = array(
        'icon'			=> get_template_directory_uri() . '/base/executive/img/',
        'icon_width'	=> '70',
        'icon_height'	=> '40',
            ...
            switch ( $style ) {
                ...
                case 'style-2' :
                    ...
                    $settings = wp_parse_args(array(
                        ...
                        'menu_bg_gradient'                  => array('start' => $val[1], 'end' => $val[2]),
                        'menu_corners'                      => '4px',
                        'menu_apply_border'                 => '1',
                    ...
                    if ( $key == 'default' ) {
                        ...
                        $settings['header_mobile_bg_color'] = '#333333';
                        $settings['menu_bg_gradient'] = array('start' => '#fefefe', 'end' => '#f3f3f3');
