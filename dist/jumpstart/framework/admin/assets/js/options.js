	...
	admin.options.setup = function( element ) {
		...
		if ( $.isFunction( $.fn.wpColorPicker ) ) {
			...
			$element.find( '.section-button' ).each( function() {
				...
				$parent.find( '.color.bg .wp-color-result' ).attr( 'title', l10n.bg_color );

				$parent.find( '.color.bg_hover .wp-color-result' ).attr( 'title', l10n.bg_color_hover );

				$parent.find( '.color.border .wp-color-result' ).attr( 'title', l10n.border_color );

				$parent.find( '.color.text .wp-color-result' ).attr( 'title', l10n.text_color );

				$parent.find( '.color.text_hover .wp-color-result' ).attr( 'title', l10n.text_color_hover );
