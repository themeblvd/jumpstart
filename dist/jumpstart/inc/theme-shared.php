	...
	switch ( $set ) {
		...
		case 'mobile-header':
			...
			$options['header_mobile_height'] = array(
				...
				'desc'    => __( 'Set the height of your mobile header. This number should be higher than the height of your mobile logo image at <em>Layout > Mobile Header</em>.', 'jumpstart' ),
				'std'     => '64px',
				'type'    => 'slide',
				'options' => array(
					'min'   => '40',
