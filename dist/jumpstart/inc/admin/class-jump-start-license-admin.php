				...
				switch ( $item['error'] ) {
					...
					case 'expired':
						...
						$status['message'] = sprintf(
							...
							__( 'Your license key expired on %s. Please <a href="%s" target="_blank">renew your license key</a>.', 'jumpstart' ),
					...
					case 'site_inactive':
						...
						$status['message'] = sprintf(
							...
							__( 'Your %s is not active for this URL. Please <a href="%s" target="_blank">visit your account page</a> to manage your license key URLs.', 'jumpstart' ),
					...
					default:
						...
						$status['message'] = sprintf(
							...
							__( 'There was an error with this license key: %s. Please <a href="%s">contact our support team</a>.', 'jumpstart' ),
							$error,
				 ...
				 if ( 'lifetime' === $item['expires'] ) {
					 ...
					 if ( $expiration > $now && $expiration - $now < ( DAY_IN_SECONDS * 30 ) ) {
						 ...
						 $status['message'] = sprintf(
							 ...
							 __( 'Your license key expires soon! It expires on %s. <a href="%s" target="_blank">Renew your license key</a>.', 'jumpstart' ),
							 date_i18n( get_option( 'date_format' ), strtotime( $license->expires, current_time( 'timestamp' ) ) ),
