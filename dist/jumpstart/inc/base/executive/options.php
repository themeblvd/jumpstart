...
function jumpstart_ex_options() {
	...
	themeblvd_add_option_section( 'styles', 'ex_sticky_header', __( 'Sticky Header', 'jumpstart' ),   null, $options['header_sticky'] );
	...
	themeblvd_add_option_section( 'styles', 'ex_side_panel',    __( 'Side Panel', 'jumpstart' ),      null, $options['side'] );
